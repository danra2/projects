      ...
      <div>
        ...
        <div>
          ...
          <div className="wrapper-mobile">
            <img src={require("./images/hero1.png")} alt="" />
          </div>
            ...
            <div className="row">
              ...
              <div className="col-sm-6 cols">
                <p className="img-caption">
                  ...
                  attempt to remove the pumpkin results in mashed squash. From
                  the Monday, March 16, 1998 issue of The Cornell Daily Sun.
                </p>
              </div>
            </div>
            <p className="bodyparas">
          ...
          <p className="sketch-caption">
            <span className="img-caption-bold">300 meters</span> | Was the
            pumpkin flung from the far-away engineering quad via catapult?
          </p>
          <div className="content">
            <p className="bodyparas">
          ...
          <p className="sketch-caption">
            ...
            President Hunter Rawlings III stand up straight and place the
